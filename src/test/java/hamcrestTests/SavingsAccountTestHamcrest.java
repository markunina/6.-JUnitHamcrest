...
public class SavingsAccountTestHamcrest {
    SavingsAccount sut = new SavingsAccount(0);
    ...
    public static void completeSuite() {
        System.out.println("SavingsAccountTest complete");
    }
    ...
    public void testConstructor(SavingsAccount account) {
        //given
        sut = account;
    ...
    private static Stream<Arguments> sourceTestConstructor() {
        return Stream.of(
                Arguments.of(new SavingsAccount(-1000)),
                Arguments.of(new SavingsAccount(-1)),
                Arguments.of(new SavingsAccount(0)),
                Arguments.of(new SavingsAccount(1000)));
    }
}
